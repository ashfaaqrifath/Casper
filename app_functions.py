...
def open_program(command, voice_var, log):
    if "chrome" in command.lower():
        ...
        casper_log(write=Fore.GREEN + "Opening Google Chrome".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Opening Google Drive".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Opening Visual Studio Code".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Opening YouTube Downloader".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Opening Microsoft Word".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Opening Microsoft Excel".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Opening Microsoft Access".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Opening File Explorer".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Opening Notepad".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Opening Zoom".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Activating VPN".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Accessing Task Manager".center(100), var=log)
        return
...
def close_program(command, voice_var, log):
    if "chrome" in command:
        ...
        casper_log(write=Fore.GREEN + "Closing Google Chrome".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Closing Microsoft Excel".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Closing Microsoft Word".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Closing Visual Studio Code".center(100), var=log)
        return
        ...
        casper_log(write=Fore.GREEN + "Closing Notepad".center(100), var=log)
        return