...
def casper_listen():
    ...
    try:
        ...
        print(Fore.LIGHTBLACK_EX + " Command not recieved, Stand by")
        return 0
...
def search_web(command):
    if "youtube" in command.lower():
        ...
        print(Fore.GREEN + "Opened new chrome tab")
