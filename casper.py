...
def open_application(command):
    if "chrome" in command.lower():
        print(Fore.GREEN + "Opening Google Chrome")
...
def close_application(command):
    if "chrome" in command:
        print(Fore.GREEN + "Closing Google Chrome")
...
def search_web(command):
    if "youtube" in command.lower():
        ...
        print(Fore.GREEN + "Opening Stack Overflow")
        ...
        print(Fore.GREEN + "Opened a new chrome tab")
        casper_speak(speak="opened a new chrome tab", voice=casper_voice)
        return
        ...
        print(Fore.GREEN + "Enabled Incognito mode")
...
def play_music():
    print(Fore.GREEN + "Playing music from music directory")
...
def recognize(command):
    try:
        if "search" in command or "where is" in command or "YouTube" in command or "wikipedia" in command.lower():
            ...
            print(Fore.GREEN + "Your name is Ashfaaq Rifath.")
            ...
            print(Fore.GREEN + "Speech recognition enabled.")
...
if __name__ == "__main__":
    ...
    if nowTime >= 0 and nowTime < 12:
        ...
        print(Fore.CYAN + f"{greet}, what can i do for you?")
